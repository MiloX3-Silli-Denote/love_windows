-- same as openWindow.lua except there is no need to call load, quit, or update on it
-- not allowed to redefine love.run or love.errorhandler if this one is used tho
...
-- copied and slightly modified from the love2d default run function
-- modified sections marked with a '--' at the end
function love.run()
  OpenWindow.clear(); --
  unfilteredArgs = arg; --
